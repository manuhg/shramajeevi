          ...
          <div className="row">
            <div className="col-10 offset-1 text-justify">
              ...
              <p>
                ...
                for free download of agricultural and rural images and{' '}
                <a href="https://shramajeevicontacts.com" target="_blank" rel="noopener noreferrer">
                  <u>shramajeevicontacts.com</u>
                </a>{' '}
                a digital directory for agriculture. In the year 2017, we have brought out another website{' '}
                <a href="shramajeewiki.com" target="_blank" rel="noopener noreferrer">
                  <u>shramajeewiki.com</u>
                </a>{' '}
                for knowledgeable articles on agriculture. In June 2018 we have launched the business version of
                agriculture digital directory as{' '}
                <a href="https://agdial.in" target="_blank" rel="noopener noreferrer">
                  <u>agdial.in</u>
                </a>
                . In near future Shramajeevi is getting in to E-commerce business exclusive for agriculture with{' '}
                <a href=" ">
                  <u>agtrade.in</u>
                </a>
                .{' '}
